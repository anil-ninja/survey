<div class="wrapper">
	...
	<div class="quest"  id="question">Does your domestic helper provide replacement when they take leave?</div><br/><br/>
	<div class="content">
		<div class="content-wrapper">
			...
			<div class="confirm container">
				<div class="button-wrapper confirm">
					<div class="button nav enabled" onclick="submit(6);" id="submit1"><span>Ok</span><span class="confirm"></span> 	</div>
				</div>
